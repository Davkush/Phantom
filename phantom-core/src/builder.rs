...
use crate::hybrid_kem::{encapsulate, HybridCiphertext, HybridPublicKey, HybridSharedSecret};
...
pub fn build_packet(
    ...
    for i in (0..hops).rev() {
        ...
        let mac_key = derive_key(&shared_secret.x25519_ss, KdfPurpose::HeaderMac, b"mac_check");
        shake.update(&mac_key.0);
